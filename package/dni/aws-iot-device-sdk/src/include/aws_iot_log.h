...
#define IOT_DEBUG(...)    \
	{\
	console_printf("DEBUG:   %s L#%d ", __func__, __LINE__);  \
...
#define FUNC_ENTRY    \
	{\
	console_printf("FUNC_ENTRY:   %s L#%d \n", __func__, __LINE__);  \
	}
#define FUNC_EXIT    \
	{\
	console_printf("FUNC_EXIT:   %s L#%d \n", __func__, __LINE__);  \
	}
#define FUNC_EXIT_RC(x)    \
	{\
	console_printf("FUNC_EXIT:   %s L#%d Return Code : %d \n", __func__, __LINE__, x);  \
	return x; \
	}
#else
#define FUNC_ENTRY
...
#define IOT_WARN(...)   \
	{ \
	console_printf("WARN:  %s L#%d ", __func__, __LINE__);  \
	console_printf(__VA_ARGS__); \
	console_printf("\n"); \
	}
#else
...
#define IOT_ERROR(...)  \
	{ \
	console_printf("ERROR: %s L#%d ", __func__, __LINE__); \
	console_printf(__VA_ARGS__); \
	console_printf("\n"); \
	}
#else
