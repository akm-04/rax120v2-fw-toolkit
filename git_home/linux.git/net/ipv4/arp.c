...
uint32_t a2ln(char *addr)
{
      int i1 = 0, i2 = 0, i3 = 0, i4 = 0;
      sscanf(addr,"%d.%d.%d.%d", &i4, &i3, &i2, &i1);
      return (uint32_t)( (i1<<24) | (i2<<16) | (i3<<8) | (i4));
}
...
void add_ipmac_table(uint32_t sip, unsigned char mac[32])
{
...
int ipmac_member(uint32_t sip, unsigned char mac[6])
{
...
{
    ipmac_proc_entry = proc_create(IPMAC_PROC_NAME, 0666, NULL, &proc_ipmac_operations);
    if (!ipmac_proc_entry)
    {
