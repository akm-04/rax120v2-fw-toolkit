...
int checkboard(void)
{
    printf("U-boot dni1 V1.8 for DNI HW ID: 29765589; NAND flash 512MB; RAM 1024MB .\n");
	printf("developed based on 'qsdk-ipq807x.ilq.10.0-spf.10.0.CS_patch_4' \n");
    return 0;
}
#endif
...
#ifdef NMRP_FLAG
	snprintf(runcmd, sizeof(runcmd), "nmrp_flag_set 1");
	run_command(runcmd,0);
#endif
