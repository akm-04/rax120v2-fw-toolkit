...
#elif defined(CONFIG_HW29766193P0P256P512P2X2P2X2)
#include <../board/qca/hw29766193p0p256p512p2x2p2x2/hw29766193p0p256p512p2x2p2x2.h>
#elif defined(CONFIG_IPQ_RUMI)
#ifdef CONFIG_IPQ807X
#include <../board/qca/ipq807x/ipq807x.h>
#endif
#ifdef CONFIG_HW29765589P0P512P1024P4X4P8X8
#include <../board/qca/hw29765589p0p512p1024p4x4p8x8/hw29765589p0p512p1024p4x4p8x8.h>
#endif
#ifdef CONFIG_HW29766094P0P256P512P2X2P2X2
#include <../board/qca/hw29766094p0p256p512p2x2p2x2/hw29766094p0p256p512p2x2p2x2.h>
#endif
#ifdef CONFIG_HW29765960P0P4000P1000P4X4P4X4P4X4
#include <../board/qca/hw29765960p0p4000p1000p4x4p4x4p4x4/hw29765960p0p4000p1000p4x4p4x4p4x4.h>
#endif
#ifdef CONFIG_HW29766097P0P512P1024P2X2P2X2P2X2
#include <../board/qca/hw29766097p0p512p1024p2x2p2x2p2x2/hw29766097p0p512p1024p2x2p2x2p2x2.h>
#endif
#endif
...
int run_command_list(const char *cmd, int len, int flag);
    ...
    defined(CONFIG_HW29765960P0P4000P1000P4X4P4X4P4X4) || \
...
#if defined(CONFIG_HW29766193P0P256P512P2X2P2X2)
...
#endif
#if defined(CONFIG_TARGET_AM335X_EVM)
int	saveenv	     (void);
#endif
