 ...
 */
#ifndef _HW29766097P0P512P1024P2x2P2x2P2x2_H
#define _HW29766097P0P512P1024P2x2P2x2P2x2_H

#ifndef DO_DEPS_ONLY
#include <generated/asm-offsets.h>
#endif
#include <linux/sizes.h>
#include <dt-bindings/qcom/gpio-hw29766097p0p512p1024p2x2p2x2p2x2.h>
...
#define CONFIG_BOOTCOMMAND  	"mii write 0x1c 0x0 0x800; sleep 1; nmrp; bootdni; dnibootm"
...
#define CONFIG_HW29766097P0P512P1024P2X2P2X2P2X2
...
#define CONFIG_SYS_IMAGE_BASE_ADDR  0x2900000
#define CONFIG_SYS_IMAGE_2_BASE_ADDR 0x8d00000
#define CONFIG_SYS_IMAGE_ADDR_BEGIN  0x2900000
#define CONFIG_SYS_IMAGE_2_ADDR_BEGIN 0x8d00000
#define CONFIG_SYS_IMAGE_ADDR_END   (CFG_IMAGE_BASE_ADDR + CFG_IMAGE_LEN)
#define KERNEL_SIZE 0x560000
#define CONFIG_SYS_STRING_TABLE_BASE_ADDR          0xf100000
...
#define CONFIG_SYS_FLASH_CONFIG_BASE  0x2300000
#define CONFIG_SYS_FLASH_CONFIG_PARTITION_SIZE  0x100000
#define CONFIG_SYS_VPN_BASE_ADDR	0x0f600000
#define CONFIG_SYS_MTDOOPS_BASE_ADDR	0x0f700000
...
#define BOARDDATA2_ADDR				0x2500000
#define BOARDDATA2_LEN				0x100000

#define BOARD_BOOT_PARTITION_OFFSET           0x00
...
#define CONFIG_EXTRA_ENV_SETTINGS                   \
    "delenv=nand erase 0xd00000 0x80000\0"               \

#define LED_CLK_GPIO 40
#define LED_DATA_GPIO 41
#define LED_CLR_GPIO 39
...
#define POWER_LED_GREEN			4
#define POWER_LED_RED			5
#define RING_LED_BLUE_SR		6
#define RING_LED_GREEN_SR		7
#define RING_LED_RED_SR			8
#define RING_LED_WHITE_SR		9
...
#endif /* _HW29766097P0P512P1024P2x2P2x2P2x2_H */
