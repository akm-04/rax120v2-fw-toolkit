...
#ifndef _HW29765960P0P4000P1000P4X4P4X4P4X4_H
#define _HW29765960P0P4000P1000P4X4P4X4P4X4_H

#ifndef DO_DEPS_ONLY
#include <generated/asm-offsets.h>
#endif
#include <linux/sizes.h>
#include <dt-bindings/qcom/gpio-hw29765960p0p4000p1000p4x4p4x4p4x4.h>
...
#define CONFIG_BOOTCOMMAND  	"mii write 0x0 0x0 0x800; sleep 1; nmrp; bootdni; bootm 0x40000000#config@hk01"
...
#define TFTPPUT_DUMP_IMAGE

#if defined(CONFIG_QCA_APPSBL_DLOAD) || defined(TFTPPUT_DUMP_IMAGE)
...
#define CONFIG_HW29765960P0P4000P1000P4X4P4X4P4X4
...
#define CFG_IMAGE_LEN   0x06400000
#define CFG_IMAGE_BASE_ADDR  0x1204400
#define CFG_IMAGE_BASE_ADDR_SECOND 0x7604400
#define IMAGE_BASE_BLOCK 0x9022
#define IMAGE_IMAGE_COUNT 0x32000
#define IMAGE_BASE_BLOCK_SECOND_FW 0X3b022
#define IMAGE_IMAGE_COUNT_SECOND_FW 0x32000
#define KERNEL_SIZE 0x2C00
#define CONFIG_SYS_IMAGE_ADDR_END   (CFG_IMAGE_BASE_ADDR + CFG_IMAGE_LEN)
#define CONFIG_SYS_STRING_TABLE_BASE_ADDR          0xda04400
#define CONFIG_SYS_STRING_TABLE_LEN                0x50000
#define CONFIG_SYS_STRING_TABLE_NUMBER 10
#define CONFIG_SYS_STRING_TABLE_TOTAL_LEN          0x500000
...
#define CONFIG_SYS_FLASH_CONFIG_BASE  0x0010c4400
#define CONFIG_SYS_FLASH_CONFIG_PARTITION_SIZE  0x40000
#define CONFIG_SYS_VPN_BASE_ADDR	0x0df44400
#define CONFIG_SYS_MTDOOPS_BASE_ADDR	0x0df04400
#define CONFIG_SYS_MTDOOPS_LEN			0x40000
...
/* 12(lan/wan) + 6(wlan5g) + 6(wlan2nd5g) + 6(bluetooth) + 8(wpspin) = 38 (0x26)*/
...
#define BOARD_HW_ID_LENGTH          36
#define BOARD_HW_ID_REAL_LENGTH     34
...
#define BOARDDATA2_ADDR				0x1084400
...
#define BOARD_BOOT_PARTITION_OFFSET (BOARD_BACKHAUL_PASSPHRASE_OFFSET + BOARD_BACKHAUL_PASSPHRASE_LENGTH + 4 )
#define BOARD_BOOT_PARTITION_LENGTH           2
#endif
...
#define CONFIG_EXTRA_ENV_SETTINGS                   \
    "delenv=mmc erase 0x3022 0x200\0"               \
...
#endif /* _HW29765960P0P4000P1000P4X4P4X4P4X4_H */
